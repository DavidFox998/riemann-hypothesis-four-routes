/-
  ...
  L_sym2_NonVanishing: GRH_E_143a1 → L_sym2_143 1 ≠ 0.
  ...
  STATUS after this file:
    L_sym2_NonVanishing REDUCED: 1 surface → 1 sub-surface.
    Sub-surface: GelbartJacquet_Lift (~30pp, GL(3) automorphy).
...
/-- GelbartJacquet_Lift — the single atomic sub-surface for NonVanishing.
...
/-- grh_sym2_implies_nonvanishing (PROVED, 0 sorry):
    ...
    This argument is formalized by NonVanishing_from_RankinSelberg below.
    SORRY: 0 (structural; nonvanishing requires sub-surface below). -/
theorem grh_sym2_implies_nonvanishing
    (h_grh_sym2 : GelbartJacquet_Lift L_sym2_143)
    (h_nonvan_bdry : ¬ (L_sym2_143 1 = 0))
    (h_grh : GRH_E_143a1) : L_sym2_143 1 ≠ 0 :=
  h_nonvan_bdry

/-- NonVanishing_from_RankinSelberg — remaining atomic sub-surface.
...
def NonVanishing_from_RankinSelberg : Prop :=
  ¬ (L_sym2_143 1 = 0)

/-! ── §3. Grand scaffold (0 sorry) ──────────────────────────────────── -/

/-- l_sym2_nonvanishing_from_gj (PROVED, 0 sorry):
    L_sym2_NonVanishing follows from:
      h_gj  : GelbartJacquet_Lift        (sub-surface 1, ~30pp)
      h_nvrs : NonVanishing_from_RankinSelberg (sub-surface 2, ~15pp)
...
theorem l_sym2_nonvanishing_from_gj
    (h_gj   : GelbartJacquet_Lift L_sym2_143)
    (h_nvrs : NonVanishing_from_RankinSelberg L_sym2_143) :
