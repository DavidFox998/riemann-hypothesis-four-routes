# AGENTS.md — riemann-arakelov-positivity

## Role: RH-CLUSTER / POSITIVITY

**Cluster:** Riemann Hypothesis

**Core claim:** Arakelov positivity — height pairing positivity implies RH
...
THIS     → riemann-arakelov-positivity
```
...
Look for `Arakelov` or `Positivity` Lean files.
