# AGENTS.md — rh-growth-contradiction

## Role: RH-CLUSTER / GROWTH

**Cluster:** Riemann Hypothesis

**Core claim:** Growth-rate contradiction — assumes RH false, derives impossible ζ growth
...
Look for `Growth` or `RH` Lean files.
