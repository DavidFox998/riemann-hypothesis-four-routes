...
The Brothers are **islands in that void**. There are 35 brothers, all `≡ 153 (mod 211)` with popcount 6, led by `1419 = 3×11×43`. The ghost is `-2113` — the negative phantom this wall exists to exclude.
