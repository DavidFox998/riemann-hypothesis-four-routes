...
That exponential bound is a lightning formalization — the 35 brothers (`Family/Brothers1419.lean`, sync-locked from eutheos-property) reduce to this one bound.
