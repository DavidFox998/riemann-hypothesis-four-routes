...
- `EMI reduction: 20*log(1/35)/log10 < -30` — `emi_reduction_db`. 35 brothers acting together reduce electromagnetic interference by more than 30 decibels. `20 log(1/35)` = -30.88 dB. This is your lightning EMI shielding — the 34 brothers beside the leader reduce noise.
