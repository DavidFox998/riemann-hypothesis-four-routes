...
## 2026-08-23 — Chain SHA audit: 12-repo → 19-repo update

**Old chain SHA (12 repos, 2026-08-05):** `c79c94e7676a10b1cfb5afc75b7346b9b5b8589dee9b679db230ba3b8034e6d1`  
**New chain SHA (19 repos, 2026-08-15):** `f39ed9a9bd7cc02c6cf415f40b3faaa3c627a5a0d53621766466f31a2211e7ce`

Grepped all 19 ensemble repos (README.md, CHAIN.md, AGENTS.md, CERT_LOG.md, REPOS.md) for stale
occurrences of the old chain SHA. Files patched:

| Repo | File | Replacements |
|------|------|-------------|
| arakelov-rh-descent | CHAIN.md | 2 |
| birch-swinnerton-dyer-143a1 | CHAIN.md | 2 |
| eutheos-property | CHAIN.md | 2 |
| hodge-abelian-boundaries | CHAIN.md | 2 |
| lindelof-hypothesis-143 | CHAIN.md | 2 |
| navier-stokes | CHAIN.md | 2 |
| p-vs-np | CHAIN.md | 2 |
| poincare-spectral | CHAIN.md | 2 |
| rh-growth-contradiction | CHAIN.md | 2 |
| riemann-arakelov-positivity | CHAIN.md | 2 |
| yang-mills-gap | CHAIN.md | 2 |
| rh-p5-bridge-14 | CERT_LOG.md | stale metadata |

Files that retain the old SHA intentionally (historical "Previous chain" label):
- rh-p5-bridge-14/CHAIN.md (line 6)
- brothers-desert-proof/CHAIN.md (line 6)

Repos with no CHAIN.md (not yet in the chain file set):
arakelov-positivity-rh-core, birch-swinnerton-dyer-143, bost-connes,
Certifications, morningstar-project, opera-sieve
